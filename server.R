# 
# code_lines <- readLines("C:/Users/falasca/OneDrive/Dokumente/ClimeApp/ClimeApp_development/server.R")
# code_lines <- readLines("C:/Users/falasca/Desktop/server - Copy.R")
# 
# brackets <- grep("\\{|\\}", code_lines, value = TRUE)
# open_brackets <- sum(grepl("\\{", brackets))
# close_brackets <- sum(grepl("\\}", brackets))
# brackets <- open_brackets-close_brackets
# cat("Open brackets: ", open_brackets, "\n")
# cat("Close brackets: ", close_brackets, "\n")
# cat(brackets, "\n")
