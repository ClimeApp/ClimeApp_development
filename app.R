...
# Ther is always evil laughter ggg
...
ui <- navbarPage(id = "nav1",
          ...
          title = div(style = "display: inline;",
                      ...
                      img(src = 'pics/Font_ClimeApp_Vers3_weiss.png', id = "ClimeApp2", height = "75px", width = "225px", style = "align-left: -10px"), "(Beta)",
        ...
        sidebarLayout(
          ...
          sidebarPanel(verticalLayout(
            ...
            fluidRow(
              ...
              column(width = 6, h5(helpText("1422 to 2000 AD"))),
      ...
      tabPanel("Average & anomaly", id = "tab1",
                ...
                sidebarPanel(verticalLayout(
                    ...
                    numericRangeInput(inputId    = "range_years",
                                       label     = "Select the range of years (1422-2000):",
                                       value     = c(1422,2000),
                                       separator = " to ",
                                       min       = 1422,
                                       max       = 2000),
                    ...
                    verticalLayout(br(),
                          ...
                          fluidRow(
                            column(width = 3,
                                   ...
                                   downloadButton(outputId = "download_fad_wa", label = "Download Oct. - Mar. Y1")),
                            column(width = 3,
                                   radioButtons(inputId = "file_type_modera_source_b", label = "Choose file type:", choices = c("png", "jpeg", "pdf"), selected = "png", inline = TRUE),
                                   downloadButton(outputId = "download_fad_sa", label = "Download Apr. - Sept. Y1")),
                            column(width = 3,
                                   radioButtons(inputId = "file_type_modera_source_c", label = "Choose file type:", choices = c("png", "jpeg", "pdf"), selected = "png", inline = TRUE),
                                   downloadButton(outputId = "download_fad_wb", label = "Download Oct. - Mar. Y2")),
                            column(width = 3,
                                   radioButtons(inputId = "file_type_modera_source_d", label = "Choose file type:", choices = c("png", "jpeg", "pdf"), selected = "png", inline = TRUE),
                                   downloadButton(outputId = "download_fad_sb", label = "Download Apr. - Sept. Y2"))
                          ),
                          br(),
                            ...
                            verticalLayout(br(),
                                    ...
                                    fluidRow(
                                      column(width = 3,
                                             ...
                                             downloadButton(outputId = "download_fad_wa2", label = "Download Oct. - Mar. Y1")),
                                      column(width = 3,
                                           ...
                                           downloadButton(outputId = "download_map_data3", label = "Download")), br(),
                                            ...
                                            fluidRow(
                                              ...
                                              column(width = 3,
                                                     ...
                                                     downloadButton(outputId = "download_fad_wa3a", label = "Download Oct. - Mar. Y1")),
                                              column(width = 3,
                                                     radioButtons(inputId = "file_type_modera_source_b3a", label = "Choose file type:", choices = c("png", "jpeg", "pdf"), selected = "png", inline = TRUE),
                                                     downloadButton(outputId = "download_fad_sa3a", label = "Download Apr. - Sept. Y1")),
                                            ))),
                                            br(),
                                            shinyjs::hidden(
                                            ...
                                            fluidRow(
                                              ...
                                              column(width = 3,
                                                     ...
                                                     downloadButton(outputId = "download_fad_wa3b", label = "Download Oct. - Mar. Y1")),
                                              column(width = 3,
                                                     radioButtons(inputId = "file_type_modera_source_b3b", label = "Choose file type:", choices = c("png", "jpeg", "pdf"), selected = "png", inline = TRUE),
                                                     downloadButton(outputId = "download_fad_sa3b", label = "Download Apr. - Sept. Y1")),
                                            ))),
                   )
                                        ...
                                        div(id = "hidden_iv_fad_download",
                                            fluidRow(
                                              ...
                                              column(width = 3,
                                                     ...
                                                     downloadButton(outputId = "download_fad_wa4a", label = "Download Oct. - Mar. Y1")),
                                              column(width = 3,
                                                     radioButtons(inputId = "file_type_modera_source_b4a", label = "Choose file type:", choices = c("png", "jpeg", "pdf"), selected = "png", inline = TRUE),
                                                     downloadButton(outputId = "download_fad_sa4a", label = "Download Apr. - Sept. Y1")),
                                            ))),
                                      br(),
                                      shinyjs::hidden(
                                        div(id = "hidden_dv_fad_download",
                                            fluidRow(
                                              ...
                                              column(width = 3,
                                                     ...
                                                     downloadButton(outputId = "download_fad_wa4b", label = "Download Oct. - Mar. Y1")),
                                              column(width = 3,
                                                     radioButtons(inputId = "file_type_modera_source_b4b", label = "Choose file type:", choices = c("png", "jpeg", "pdf"), selected = "png", inline = TRUE),
                                                     downloadButton(outputId = "download_fad_sa4b", label = "Download Apr. - Sept. Y1")),
                                            ))),
             )
           ...
           mainPanel(tabsetPanel(
             ...
             tabPanel("ModE-RA sources", br(),
                      fluidRow(
                        ...
                        # Latitude 1
                        column(width=4,
                               numericRangeInput(inputId = "fad_latitude_b5",
                                          label = "Latitude range (-90/90):",
                                          value = c(43,50),
                                          separator = " to ",
                                          min = -90,
             ...
             tabPanel("Downloads",
                      ...
                      fluidRow(
                        column(width = 3,
                               ...
                               downloadButton(outputId = "download_fad_wa5", label = "Download Oct. - Mar. Y1")),
                        column(width = 3,
                               radioButtons(inputId = "file_type_modera_source_b5", label = "Choose file type:", choices = c("png", "jpeg", "pdf"), selected = "png", inline = TRUE),
                               downloadButton(outputId = "download_fad_sa5", label = "Download Apr. - Sept. Y1")),
                        column(width = 3,
                               radioButtons(inputId = "file_type_modera_source_c5", label = "Choose file type:", choices = c("png", "jpeg", "pdf"), selected = "png", inline = TRUE),
                               downloadButton(outputId = "download_fad_wb5", label = "Download Oct. - Mar. Y2")),
                        column(width = 3,
                               radioButtons(inputId = "file_type_modera_source_d5", label = "Choose file type:", choices = c("png", "jpeg", "pdf"), selected = "png", inline = TRUE),
                               downloadButton(outputId = "download_fad_sb5", label = "Download Apr. - Sept. Y2"))
                      ),
...
server <- function(input, output, session) {
  ...
  pp_id <- reactive({
    ...
    ppid = generate_pp_data_ID(input$variable_selected, month_range())
  ...
  data_output1 <- reactive({
    ...
    #Combining Shiny Input with ModeRa Data
    data_input <-   switch(input$variable_selected,
                           "Temperature"   = temp_data,
                           "Precipitation" = prec_data,
                           "SLP"           = SLP_data,
                           "Z500"          = Z500_data)
  ...
  plot_titles <- reactive({
    ...
    my_title <- generate_titles("general", input$variable_selected, input$mode_selected, input$title_mode,input$title_mode_ts,
  ...
  output$timeseries <- renderPlot({timeseries_plot()}, height = 400)
    ...
    #Generating Custom NetCDF
    
    custom_netcdf <- reactive({
      
      customnet <- generate_custom_netcdf (data_output3(), "general", plot_titles(), input$variable_selected, input$netcdf_variables, input$mode_selected, subset_lons(), subset_lats(), month_range(), input$range_years, input$ref_period, NA)
    ...
    output$download_fad_sb             <- downloadHandler(filename = function(){paste("Assimilated Observations_summer_",input$fad_year_b, "-modera_source.",input$file_type_modera_source_d, sep = "")},
                                                          content  = function(file) {
                                                            
                                                            mmd = generate_map_dimensions(subset_lons(), subset_lats(), session$clientData$output_fad_winter_map_a_width, input$dimension[2], FALSE)
                                                            
                                                            if (input$file_type_modera_source_d == "png"){
                                                              png(file, width = mmd[3] , height = mmd()[4], res = 400)  
                                                              print(fad_sb())
                                                              dev.off()
                                                            } else if (input$file_type_modera_source_d == "jpeg"){
                                                              jpeg(file, width = mmd[3] , height = mmd[4], res = 400) 
                                                              print(fad_sb()) 
                                                              dev.off()
                                                            } else {
    ...
    output$download_fad_wb             <- downloadHandler(filename = function(){paste("Assimilated Observations_winter_",input$fad_year_b, "-modera_source.",input$file_type_modera_source_c, sep = "")},
                                                          content  = function(file) {
                                                            
                                                            mmd = generate_map_dimensions(subset_lons(), subset_lats(), session$clientData$output_fad_winter_map_a_width, input$dimension[2], FALSE)
                                                            
                                                            if (input$file_type_modera_source_c == "png"){
                                                              png(file, width = map_dimensions()[3] , height = map_dimensions()[4], res = 400)  
                                                              print(fad_wb())
                                                              dev.off()
                                                            } else if (input$file_type_modera_source_c == "jpeg"){
                                                              jpeg(file, width = map_dimensions()[3] , height = map_dimensions()[4], res = 400) 
                                                              print(fad_wb()) 
                                                              dev.off()
                                                            } else {
                                                              pdf(file, width = map_dimensions()[3]/400 , height = map_dimensions()[4]/400) 
                                                              print(fad_wb())
                                                              dev.off()
                                                            }})
    ...
    output$download_netcdf             <- downloadHandler(filename = function() {paste(plot_titles()$netcdf_title, ".nc", sep = "")},
                                                          content  = function(file) {
                                                            ...
                                                            generate_custom_netcdf (data_output3(), "general",netcdf_ID, input$variable_selected, input$netcdf_variables, input$mode_selected, subset_lons(), subset_lats(), month_range(), input$range_years, input$ref_period, NA)
  ...
  pp_id_2 <- reactive({
    ...
    ppid2 = generate_pp_data_ID(input$variable_selected2, month_range_2())
  ...
  data_output1_2 <- reactive({
    ...
    #Combining Shiny Input with ModeRa Data
    data_input_2 <-   switch(input$variable_selected2,
                             "Temperature"   = temp_data,
                             "Precipitation" = prec_data,
                             "SLP"           = SLP_data,
                             "Z500"          = Z500_data)
  ...
  plot_titles_2 <- reactive({
    ...
    my_title <- generate_titles ("composites", input$variable_selected2, input$mode_selected2, input$title_mode2,input$title_mode_ts2,
  ...
  ## CORRELATION data processing and plotting ----
    ...
    # Generate pp ID
    pp_id_v1 <- reactive({
      ppid_v1 = generate_pp_data_ID(input$ME_variable_v1, month_range_v1())
      return(ppid_v1)
    })
    
    #Geographic Subset
    data_output1_v1 <- reactive({ 
      data_input_v1 <-   switch(input$ME_variable_v1,"Temperature"= temp_data,"Precipitation" = prec_data,"SLP"= SLP_data,"Z500" = Z500_data)
    ...
    plot_titles_v1 <- reactive({
      my_title_v1 <- generate_titles ("general", input$ME_variable_v1, input$mode_selected_v1,
    ...
    # Generate pp ID
    pp_id_v2 <- reactive({
      ppid_v2 = generate_pp_data_ID(input$ME_variable_v2, month_range_v2())
      return(ppid_v2)
    })
    
    #Geographic Subset
    data_output1_v2 <- reactive({ 
      data_input_v2 <-   switch(input$ME_variable_v2,"Temperature"= temp_data,"Precipitation" = prec_data,"SLP"= SLP_data,"Z500" = Z500_data)
    ...
    plot_titles_v2 <- reactive({
      my_title_v2 <- generate_titles ("general", input$ME_variable_v2, input$mode_selected_v2,
    ...
    plot_titles_cor = reactive({
      ...
      ptc = generate_correlation_titles(input$source_v1,input$source_v2,variable_v1,variable_v2,
  ...
  ## REGRESSION data processing and plotting ----
    ### Independent and dependent variable ----  
      ...
      # Generate pp ID
      pp_id_dv <- reactive({
        ppid_dv = generate_pp_data_ID(input$ME_variable_dv, month_range_dv())
        return(ppid_dv)
      })
      
      #Geographic Subset
      data_output1_dv <- reactive({ 
        data_input_dv <-   switch(input$ME_variable_dv,"Temperature"= temp_data,"Precipitation" = prec_data,"SLP"= SLP_data,"Z500" = Z500_data)
      ...
      plot_titles_dv <- reactive({
        my_title_dv <- generate_titles ("general", input$ME_variable_dv, input$mode_selected_dv,
      ...
      plot_titles_iv <- reactive({
        my_title_iv <- generate_titles ("general", input$ME_variable_iv[1], input$mode_selected_iv,
      ...
      ME_ts_data_iv <- reactive({
        me_tsd_iv = create_ME_timeseries_data(input$ME_variable_iv,subset_lons_iv(),subset_lats_iv(),
    ...
    plot_titles_reg = reactive({
      ...
      ptr = generate_regression_titles(input$source_iv,input$source_dv,input$ME_variable_dv,
  ...
  ## MONTHLY TS data processing and plotting ----
    ...
    fad_wa5 <- function() {plot_modera_sources(input$fad_year_a5, "winter",input$fad_longitude_a5,input$fad_latitude_a5)}
    fad_sa5 <- function() {plot_modera_sources(input$fad_year_a5, "summer", input$fad_longitude_a5,input$fad_latitude_a5)}
    ...
    last_year = reactive({
      ...
      # Get last years
      last_yrs = tail(monthly_ts_data(),n=1)[1]
    ...
    last_coordinates = reactive({
      ...
      last_coords = unlist(strsplit(tail(monthly_ts_data(),n=1)[16],","))
